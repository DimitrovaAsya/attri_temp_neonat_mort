...
#######                                                                    ######
#######   CODE: HIA Sensitivity Analysis- Very Early Neonatal Deaths       ######
#######                             [gswp3-w5e5]                           ######
################################################################################# 
#################################################################################  
library(reshape2)
...
#Plot attributable fraction by country (old geom bar figure with both hot and cold)
...
#Uploda data with optimum temperature in absolute terms for each country
