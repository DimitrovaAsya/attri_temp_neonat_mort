...
#######                                                                    ######
#######         CODE: HIA Sensitivity Analysis- Neonatal Deaths            ######
#######                             [gswp3-w5e5]                           ######
################################################################################# 
...
#Define a matrix of exposure histories for each observation (3 days lag)
Qneonat <- data  %>% 
...
write.csv(file= here("Results", "Attributable_neonatal", "gswp3-w5e5", 
                     "obsclim_gswp3-w5e5_sensitivity.csv"),
              row.names=FALSE)
  

write.csv(df_1, here("Results", "Attributable_neonatal", "Monte_Carlo", 
                     "Factual_gswp3-w5e5_sensitivity.csv"))
 ...
 write.csv(sim, here("Results", "Attributable_neonatal", "Monte_Carlo", 
                     "Factual_gswp3-w5e5_all_countries_sensitivity.csv"))
...
attr_frac_df <- df_0 %>% 
 ...
 write.csv(file= here("Results", "Attributable_neonatal", "gswp3-w5e5", 
                      "counterclim_gswp3-w5e5_sensitivity.csv"),
          row.names=FALSE)


 write.csv(df_1, here("Results", "Attributable_neonatal", "Monte_Carlo", 
                      "Counterfactual_gswp3-w5e5_sensitivity.csv"))
...
sim <- cbind(sim_hot,sim_cold) 
write.csv(sim, here("Results", "Attributable_neonatal", "Monte_Carlo", 
                    "Counterfactual_gswp3-w5e5_all_countries_sensitivity.csv"))
