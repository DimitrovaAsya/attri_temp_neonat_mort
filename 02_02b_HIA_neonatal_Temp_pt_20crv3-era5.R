...
#######                                                                    ######
#######              CODE: HIA - Neonatal Deaths [20crv3-era5]             ######
################################################################################# 
#################################################################################  
...
for(j in countries){
    ...
    attr_f_cold <- attrdl(Qneonat, cb.temp, df_2$neonat_mort, model, 
